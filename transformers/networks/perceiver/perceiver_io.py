...
from transformers.transformers import TransformerEncoder, SelfAttentionTransformerEncoder, gen_positional_encoding
...
class PerceiverIO(nn.Module):
    ...
    def forward(self, x):
        ...
        x += gen_positional_encoding(num_tokens, dim, device=x.device)
